...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<div class="page-logo">
            <a href="index.html">
                <img src="conquer/img/logo.png" alt="logo"/>
            </a>
        </div>
		...
		<img src="conquer/img/menu-toggler.png" alt=""/>
		</a>
		...
		<ul class="nav navbar-nav pull-right">
					...
					<li>
						<ul class="dropdown-menu-list scroller" style="height: 250px;">
							<li>
								...
								<span class="photo">
								<img src="./conquer/img/avatar2.jpg" alt=""/>
								</span>
								<span class="subject">
								<span class="from">
								Lisa Wong </span>
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
								<img src="./conquer/img/avatar3.jpg" alt=""/>
								</span>
								<span class="subject">
								<span class="from">
								Richard Doe </span>
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo">
								<img src="./conquer/img/avatar1.jpg" alt=""/>
								</span>
								<span class="subject">
								<span class="from">
								Bob Nilson </span>
			...
			<li class="dropdown user">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
				<img alt="" src="conquer/img/avatar3_small.jpg"/>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="conquer/img/loading.gif" alt="loading"/>
							</div>
									...
									<div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible1="1">
										<div class="row">
											<div class="col-md-6 user-info">
												<img alt="" src="conquer/img/avatar.png" class="img-responsive"/>
												<div class="details">
													<div>
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="conquer/img/avatar1.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="conquer/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="conquer/img/avatar3.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
